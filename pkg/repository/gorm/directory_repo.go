...
func (r *GormDirectoryRepository) Update(ctx context.Context, dir *models.Directory) error {
	...
	if result.RowsAffected == 0 {
		return repository.ErrConflict // Optimistic locking failure
	}
...
func (r *GormDirectoryRepository) LockPaths(ctx context.Context, tx repository.Transaction, paths []string) error {
