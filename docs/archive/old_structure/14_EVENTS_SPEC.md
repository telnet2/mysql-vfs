...
- Watch specific checks: `file.create.validation.schema.checking`
- Alert on failures: `*.*.*.failed`
- Track completions: `*.*.completion.succeeded`
...
**Version History:**
- v2.1 (2025-10-05) - Removed legacy event types, lifecycle events only
